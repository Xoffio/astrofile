    ...
    opts = {
      ...
      status = {
        ...
        colors = function(hl)
          ...
          -- local git_changed_fg = "#FFC300"
          -- local git_added_fg = "#2B6B12"
          -- local git_removed_fg = "#892A15"
          -- hl.git_branch_fg = comment_fg
          -- hl.git_added = git_added_fg
          -- hl.git_changed = git_changed_fg
          -- hl.git_removed = git_removed_fg
      ...
      opts.statusline = {
        ...
        -- Tabnine Icon
        {
          status.component.builder {
            ...
            hl = function()
              local res = tabnine_get_status_words()
              if #res == 0 then return { fg = "buffer_overflow_fg" } end

              local fg_color = res[3] == "disabled" and { fg = "buffer_overflow_fg" } or { fg = "diag_HINT" }
              return fg_color
            end,
          },
        },
        ...
        { -- make nav section with icon border
          ...
          status.component.builder {
            ...
            surround = {
              ...
              -- NOTE: If you enable the folder option then uncomment this line and comment out the previous one
