...
- `nvim` version tested: ~~`v0.10.0`, `v0.10.3`~~, `v0.11.0`, `v0.12.4` (https://github.com/neovim/neovim/releases/tag/v0.11.0)
- Support for nvim v0.10 was dropped in AstroNvim v6 
